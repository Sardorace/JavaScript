...
// let res = automobile.filter((value) => { return value.year < 2000});

// let res = automobile.sort((a,b) => { return a.engine-b.engine})

// let res = automobile.sort((a,b) => { return a.name.localeCompare(b.name)})

// let res = automobile.sort((a,b) => { return a.year-b.year})
